...
static const CameraIntrinsics vimba_front_left_intrinsics = {
    ...
    (cv::Mat_<double>(1,4) << -0.181920, 0.050231, -0.000085, 0.001209)
};
...
static const CameraIntrinsics vimba_front_right_intrinsics = {
    ...
    (cv::Mat_<double>(1,4) << -0.185526, 0.050462, -0.000342, 0.000089)
};
...
static const CameraIntrinsics vimba_rear_left_intrinsics = {
    ...
    (cv::Mat_<double>(1,4) << -0.179032, 0.047829, 0.000395, -0.000710)
};
...
static const CameraIntrinsics vimba_rear_right_intrinsics = {
    ...
    (cv::Mat_<double>(1,4) << -0.192458, 0.059495, -0.000126, 0.000092)
};

static const CameraIntrinsics* camera_intrinsics = new CameraIntrinsics[6]{ 
